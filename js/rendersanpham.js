...
function chuyenDSObjectThanhHTML(dsSanPham) {
    ...
    for(var i=0;i<dsSanPham.length;i++){
        ...
        if(i==3){
            htmlSanPham += `<img src = "./img/banner-5.webp" alt=""  class="list-banner">`;
        }
        if(i==7){
            htmlSanPham  += `<img src = "./img/banner-10.webp" alt=""  class="list-banner">`;
        }
    ...
    html += `<div class="item">
                     <div class="item-thumb">
                        ...
                        <div class="item-btn">
                            ...
                            <button class="btn btn-primary" onclick=\'addToCart(\`${SP}\`);\'><i class="fa-solid fa-cart-plus"></i></button>
                        </div>
                    </div>`;
